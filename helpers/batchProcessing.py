...
def main():
    ...
    commands = [
        ...
        "python s3_process_video.py --data_dir data/P5_869/recordings/wristFlEx --experiment_name 1  --intact_hand Right --plane_frames_start 10 --plane_frames_end 110 --video_start 200 --video_end 3800 --process",
        "python s3_process_video.py --data_dir data/P5_869/recordings/wristFlHandCl --experiment_name 1  --intact_hand Right --plane_frames_start 10 --plane_frames_end 110 --video_start 175 --video_end 3775 --process"
]
